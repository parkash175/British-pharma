<?php $__env->startPush('header-codes'); ?>
<style>
.brochour
{
...
ul.instruction-points li {
 ...
 .section_2{
   ...
   min-height:100vh;
   padding:10px;
   background-image: url('<?php echo e(asset('images/Rectangle.jpg')); ?>');
   display:flex;
   align-items: center;
...
/* section 3 banner */
#s3_banner {
            background: url('<?php echo e(url('images/bg-sec2.jpg')); ?>') top center no-repeat #e1e1e1;
            float: left;
            width: 100%;
            height: 742px;
        }
 ...
 @media  screen and (max-width: 600px) {
        ...
        @media  screen and (max-width: 960px) {
            #s3_banner {
                height: auto;
                padding: 20px 0;
                background: url('<?php echo e(url('images/bg-sec2-res.jpg')); ?>');
            }
            #s3_banner .custom_col {
                width: 100%;
            }
...
<?php echo $__env->make('front.headerbanner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div id="welcome" class="" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="500">
        <div class="container-fluid py-5">
            ...
            <div class="wel-sup">
              <img alt="British Pharma steriods prop sub" class="prop-sub" src="<?php echo e(asset('images/prop-sub.png')); ?>" />
...
<img src="<?php echo e(asset('images/new_images/Authenticity mokeup new copy.jpg')); ?>" class="img-fluid" data-aos="-right" style="height:auto; width:100%;  border-radius:25px;   box-shadow: 10px 10px 10px grey ">
</div>
...
numeric. (eg. A528HGSR)</li>
    <li>Our Official website is Only www.british-pharma.com</li>
        ...
        <a href="<?php echo e(url('/authentication')); ?>" class=" click btn " >click here for authentication</a>
 ...
 <!--<img class="img-fluid p-0 content_banner" style="height:500px; width:1200px; align-item:center;" src="<?php echo e(url('images/new_images/4.jpg')); ?>"/> -->
       ...
       <div class="row">
           <div class="card-deck  my-5 text-center service_boxes ">
               <div class="card text-center box red solo" data-aos="zoom-in" data-aos-delay="500" >
                  <img class="service-img" src="<?php echo e(asset('images/quality.png')); ?>">
               ...
               <div class="card text-center" data-aos="zoom-in" data-aos-delay="700">
                  <img class="service-img" src="<?php echo e(asset('images/vehicle.png')); ?>">
               ...
               <div class="card text-center" data-aos="zoom-in" data-aos-delay="900">
                  <img class="service-img" src="<?php echo e(asset('images/microscope.png')); ?>">
  ...
  <div class="container mb-5">
    <div class="row">
      <div class=" extra-div1 col-lg-4 col-md-4 col-12"  data-aos="zoom-out">
        <a href="#"><img src="<?php echo e(asset('images/whologopng.png')); ?>" style="height:100px; width:100px;" alt=""></a>
        <h1>WHO</h1>
      ...
      <div class=" extra-div2 col-lg-4 col-md-4 col-12"  data-aos="zoom-out" data-aos-delay="300">
        <a href="#"><img src=" <?php echo e(asset('images/gmp.png')); ?>" style="height:100px; width:100px;" alt=""></i></a>
        <h1>GMP</h1>
      ...
      <div class=" extra-div3 col-lg-4 col-md-4 col-12" data-aos="zoom-out" data-aos-delay="500">
        <a href="#"><img src="<?php echo e(asset('images/iso.png')); ?>" style="height:100px; width:100px;" alt=""></a>
        <h1>ISO</h1>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\british-backup\resources\views/front/index.blade.php ENDPATH**/ ?>