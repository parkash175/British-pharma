...
<style>
 #particles {
  background: url('<?php echo e(asset("images/new_images/NEWBN01.png")); ?>');
...
/*@keyframes  slider{*/
/*    0%{background: url('<?php echo e(asset("images/new_images/NEWBN01.png")); ?>');}*/
/*   50%{background: url('<?php echo e(asset("images/new_images/NEWBN02.png")); ?>');}*/
/*    70%{background: url('<?php echo e(asset("images/new_images/NEWBN03.png")); ?>');}*/
...
<div class="row">
  <!--<img id="img2" src="<?php echo e(asset('images/new_images/banner.png')); ?>">-->
...
<?php $__currentLoopData = $db; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <a href="<?php echo e(url('/detail/'.$values->id)); ?>" class="list-group-item list-group-item-action"><?php echo e($values->pro_name); ?></a>
...
<?php $__currentLoopData = $db2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<a href="<?php echo e(url('/detail/'.$value->id)); ?>" class="list-group-item list-group-item-action"><?php echo e($value->pro_name); ?></a>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startPush('footer-codes'); ?>
<script>
/*(function($){
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\british-backup\resources\views/front/headerbanner.blade.php ENDPATH**/ ?>